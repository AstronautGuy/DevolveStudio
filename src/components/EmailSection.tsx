...
export default function EmailSection() {
    ...
    <Input type="email" placeholder="Email" className="font-orbitron bg-white py-7 px-7 rounded-0 placeholder:text-2xl placeholder:font-light placeholder:lowercase font-light uppercase !text-2xl" />
    <Button type="submit" className="py-7 px-7 text-lg font-orbitron">Subscribe</Button>
        </div>
        <p className="text-gray-800 font-light text-lg font-orbitron">
